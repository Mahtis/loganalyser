 ...
 * requires a dynamically generated window and also some more complex input
 * parsing. Note regardless of the added complexity, the class still implements
 * the ExtraInputHandler interface.
 *
 * @author mikkotiainen
 */
public class ExperimentRespMappingHandler implements ExtraInputHandler {
    ...
    /**
     * Initializes an ExperimentRespMappingHandler with the given
     * ExperimentWindow parent.
     *
